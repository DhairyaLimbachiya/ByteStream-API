...
namespace byteStream.Employer.API.Tests
{
    ...
    public class ApplicationServiceTests
    {
        ...
        private UserVacancyRequests _application1;
        private UserVacancyRequests _updatedApplication1;
        private UserVacancyRequests _application2;
        private UserVacancyRequests _application3;
        ...
        {
            _application1 = new UserVacancyRequests()
            {
            ...
            _updatedApplication1 = new UserVacancyRequests()
            {
                Id = new Guid("1A3D8C7E-DB11-45FE-C2B6-08DC3C361C6E"),
                VacancyId = new Guid("61EDDA4F-EBDD-42F9-ED13-08DC39205BD7"),
                UserId = new Guid("DFB764C1-0DEA-45A0-B04F-E138C0E08C22"),
            ...
            _application2 = new UserVacancyRequests()
            {
            ...
            _application3 = new UserVacancyRequests()
            {
        ...
        public async Task GetAllByUserIdAsync_ApplicationswithThatUserIdExists_ReturnsListFromDatabase()
        {
            ...
            var expecedList = new List<UserVacancyRequests> { _application1, _application2 };
            ...
            // Act
            List<UserVacancyRequests> actualList;
            using (var context = new AppDbContext(options))
            {
                var repository = new ApplicationService(context);
        ...
        public async Task GetAllByUserIdAsync_ApplicationswithThatUserIdDoesNotExists_ReturnsEmptyListFromDatabase()
        {
            ...
            //  Assert
            CollectionAssert.AreEqual(new List<UserVacancyRequests>([]), actualList, new UserVacancyRequestCompare());
        }
        ...
        public async Task GetAllByVacancyIdAsync_ApplicationswithThatVacancyIdExists_ReturnsListFromDatabase()
        {
            ...
            var expecedList = new List<UserVacancyRequests> { _application2, _application3 };
        ...
        public async Task UpdateAsync_VacancyDoesNotExists_ReturnNull()
        {
            ...
            using (var context = new AppDbContext(options))
            {
                ...
                var repository = new ApplicationService(context);
                result = await repository.UpdateAsync(_application1);
            }
        ...
        private class UserVacancyRequestCompare : IComparer
        {
            ...
            {
                var application1 = (UserVacancyRequests)x;
                var application2 = (UserVacancyRequests)y;
